 ...
 *
 */
public class PopularStreamIterator extends BaseStreamIterator {

    protected final DailyMileClient client;
    private final EntryCriteria query;
    private int currentPage = 1;
    
    public PopularStreamIterator(DailyMileClient client) {
        this(client, null);
    }
    
    public PopularStreamIterator(DailyMileClient client, EntryCriteria query) {
        this.client = client;
        this.query = query;
    }
    ...
    protected Iterator<Entry> getPageOfEntries() {
        UserStream stream = client.getPopularStream(currentPage++, query);
