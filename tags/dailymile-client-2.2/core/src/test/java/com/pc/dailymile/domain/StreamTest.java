...
public class StreamTest {
    ...
    private static final String SAMPLE_STREAM =
        "{\n"
            ...
            + "        },\n"
            + "        \"url\": \"http://www.dailymile.com/entries/23131323\",\n"
            + "        \"at\": \"2010-07-22T02:20:24Z\"\n"
            + "    },\n"
            + "    {\n"
            + "        \"id\": 232323233,\n"
            ...
            + "            \"photo_url\": \"http://media.dailymile.com/pictures/2.jpg\"\n"
            + "        },\n"
            + "        \"url\": \"http://www.dailymile.com/entries/23131322\",\n"
            + "        \"at\": \"2010-07-24T02:20:24Z\", \n"
            + "        \"comments\": [\n"
            + "        {\n"
            + "            \"body\": \"wow, awesome note\",\n"
            + "            \"created_at\": \"2010-07-23T20:57:08Z\",\n"
            + "            \"user\": {\n"
            + "                \"display_name\": \"Ben W.\",\n"
            + "                \"url\": \"http//www.dailymile.com/people/ben\",\n"
            + "                \"photo_url\": \"http://media.dailymile.com/pictures/2.jpg\"\n"
