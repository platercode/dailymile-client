 ...
 *
 */
public class PublicStreamIterator extends BaseStreamIterator {

    protected final DailyMileClient client;
    private final EntryCriteria query;
    private int currentPage = 1;
    
    public PublicStreamIterator(DailyMileClient client) {
        this(client, null);
    }
    
    public PublicStreamIterator(DailyMileClient client, EntryCriteria query) {
        this.client = client;
        this.query = query;
    }
    ...
    protected Iterator<Entry> getPageOfEntries() {
        UserStream stream = client.getPublicStream(currentPage++, query);
